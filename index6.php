...
<body class="v-dark dsn-ajax">
        ...
        <div class="dsnload p-absolute">
            <span class="dsnload__row">
                <span class="dsnload__img">
                    <img src="assets/img/icon/logo-light.png" class="logo-dark" alt="logo-light.png" decoding="async"
                        loading="lazy" />
                    <img src="assets/img/icon/logo.png" class="logo-light" alt="logo.png" decoding="async"
                        loading="lazy" />
                </span>
            </span>
            ...
            <span class="dsnload__row dsnload__row--sibling">
                <span class="dsnload__img">
                    <img src="assets/img/icon/logo-light.png" class="logo-dark" alt="logo-light" decoding="async"
                        loading="lazy" />
                    <img src="assets/img/icon/logo.png" class="logo-light" alt="logo.png" decoding="async"
                        loading="lazy" />
                </span>
    ...
    <main id="main_root" class="main-root">
            ...
            <div class="container d-grid grid-md-2 cmt-pt">
                <div class="box-left">
                    ...
                    <div class="dsn-service ctm-dsn-service">
                        ...
                        <div class="ctm-buttons mt-20 ctm-enroll-btn">
        ...
        <div class="mt-70 background-section pt-30">
            <div class="container">
                <div class="section-title text-center pb-30">
                    <div class="sub-section-title ">
                        ...
                        <span class="title-h2 title-block-lg d-block heading-color">
                            <span>Join Today <br><b>Our Coworking Space and Trading Academy</b></span>
                        </span>
                    </div>
                    <p class="dsn-heading-title d-inline-block p-relative mt-20 mb-20">
                        Elevate your professional journey by joining
                        our modern coworking space, designed for professionals, freelancers, and teams seeking an
                        inspiring environment. With high-speed internet, ergonomic workstations, and private meeting
                        rooms, you'll find the perfect blend of comfort and productivity. In addition to our dynamic
                        workspace, we offer a range of expert-led trading courses tailored for all levels. Whether
                        you're a beginner or an advanced trader, our comprehensive programs cover everything from
                        fundamental concepts to advanced strategies and algorithmic trading techniques. Discover new
                        opportunities, collaborate with like-minded individuals, and gain the skills to excel in your
                        career and trading journey—all in one place. Join us today and unlock your full potential!
                    </p>
                    <div
                        ...
                        <a class="dsn-btn  effect-ajax border-rdu move-circle ctm-explore-btn" data-dsn="parallax"
                            href="#ctm-slider" data-dsn-text="OUR PORTFOLIO">
                                    ...
                                    <div class="slide-item swiper-slide over-hidden">
                                        <div class="image-bg cover-bg w-100 h-100 before-z-index" data-overlay="4">
                                            <img class="cover-bg-img dsn-swiper-parallax-transform"
                                                src="assets/img/index/1.jpeg" alt="" data-dsn-position="50% 50%" />
                                        </div>
                                        <div class="slide-content p-absolute">
                                            ...
                                            <div class="d-flex mt-20 dsn-def-btn dsn-border-style">
                                                <a class="mr-15 dsn-btn dsn-border border-color-default background-main has-icon-left"
                                                    href="project-6.html" data-dsn-ajax="slider" data-dsn="parallax">
                        ...
                        <div class="dsn-service d-grid grid-lg-3 grid-sm-2 dsn-masonry-grid dsn-masonry-grid-2 dsn-isotope "
                            ...
                            <div class="dsn-up service-item p-relative grid-item style-box">
                                <div class="service-item-inner border-style number-item h-100 ">
                                    ...
                                    <div class="service-content p-relative">
                                        <h4 class="service_title  title-block border-bottom pb-20 mb-20">Co-Working
                                            Space</h4>
                            ...
                            <div class="dsn-up service-item p-relative grid-item style-box">
                                <div class="service-item-inner border-style number-item h-100">
                                    ...
                                    <div class="service-content p-relative">
                                        <h4 class="service_title  title-block border-bottom pb-20 mb-20"> Trading
                                            Courses
                                        </h4>
                                        <div class="service_description mt-20 max-w570 dsn-auto">
                                            <p>
                    ...
                    <div class="d-grid grid-lg-2 d-grid-no-space">
                        ...
                        <div class="box-info background-section p-80 mt-section">
                            ...
                            <ul class="d-grid dsn-list mt-20" data-dsn-gap="10px 15px">
                                ...
                                <li class="list-item d-flex align-items-center background-main">
                                    <span class="dsn-icon mr-15"><i class="fas fa-check" aria-hidden="true"></i></span>
                                    <p class="dsn-heading-title heading-color ">Innovative Spaces for Modern
                                        Professionals </p>
                                </li>
                                <li class="list-item d-flex align-items-center background-main">
                                    <span class="dsn-icon mr-15"><i class="fas fa-check" aria-hidden="true"></i></span>
                        ...
                        <div class="box-right box-creative p-relative">
                            <div class="p-relative border-rdu over-hidden h-100">
                                <div class="img-box-parallax h-100 w-100 before-z-index dsn-animate dsn-effect-left border-rdu"
                                    data-dsn-triggerhook="bottom" data-dsn-grid="move-up" data-overlay="1">
                                                        ...
                                                        <div class="testimonial-content mb-25">
                                                            <div class="quote">
                                                                <p class="max-w750 testimonial-content p-large">
                                                                    ...
                                                                    few
                                                                    questions
                                                                    purchase. He/She helped me with all the doubts.
                                                                    Also,
                                                                    they
                                                                    provide
                                                                    quick
