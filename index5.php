                ...
                <div class="section-title text-center pb-30">
                    <div class="sub-section-title ">
                        ...
                        <span class="title-h2 title-block-lg d-block heading-color">
                            <span>Join Today <br><b>Explore Our Space </b></span>
                        </span>
                    </div>
                    <p class="dsn-heading-title d-inline-block p-relative mt-20 mb-20">

                    </p>
                    <div class="mt-20 mb-20">Discover a space where innovation meets comfort. With modern amenities and
                        a
                        vibrant community,
                        our coworking space is designed to help you succeed.
                        Whether you're freelancing or part of a team, we have everything you need to thrive.</div>
                    <div
                        ...
                        <a class="dsn-btn  effect-ajax border-rdu move-circle ctm-explore-btn" data-dsn="parallax"
                            ...
                            <span class="title-btn p-relative  z-index-1">Explore <i
