...
<head>
    ...
    <title>The Trading Area: Exclusive Co-Working Space for Traders</title>
...
<div id="dsn_preloader" class="preloader">
    ...
    <div class="dsnload p-absolute">
        <span class="dsnload__row">
            ...
            <img src="assets/img/icon/logo-light.png" class="logo-dark" alt="logo-light.png" decoding="async" loading="lazy"/>
            <img src="assets/img/icon/logo.png" class="logo-light" alt="logo.png" decoding="async" loading="lazy"/>
            </span>
        </span>
        ...
        <span class="dsnload__row dsnload__row--sibling">
            <span class="dsnload__img">
               <img src="assets/img/icon/logo-light.png" class="logo-dark" alt="logo-light" decoding="async" loading="lazy"/>
            <img src="assets/img/icon/logo.png" class="logo-light" alt="logo.png" decoding="async" loading="lazy"/>
            </span>
        </span>
...
<?php include "header.php" ?>
    ...
    <div id="dsn-scrollbar">
                            ...
                            <div class="swiper-wrapper">
                                <div class="slide-item swiper-slide over-hidden">
                                    <div class="image-bg cover-bg w-100 h-100 before-z-index" data-overlay="4">
                                        <img class="cover-bg-img dsn-swiper-parallax-transform"
                                             src="assets/img/index/1.jpeg" alt=""
                                    ...
                                    <div class="slide-content p-absolute">
                                        ...
                                        <h2 class="title has-box-mod p-relative">
                                            <a href="coworking" data-dsn-split="chars" class="effect-ajax"
                                ...
                                <div class="slide-item swiper-slide over-hidden">
                                    <div class="image-bg cover-bg w-100 h-100 before-z-index" data-overlay="3">
                                        <img class="cover-bg-img dsn-swiper-parallax-transform"
                                             src="assets/img/index/2.jpeg" alt=""
                                             data-dsn-position="50% 50%"/>
                                    </div>
                                    <div class="slide-content p-absolute">
                                        <div class="p-relative head-meta swiper-animate-head  d-flex justify-content-between mb-20">
                                ...
                                <div class="slide-item swiper-slide over-hidden">
                                    <div class="image-bg cover-bg w-100 h-100 before-z-index" data-overlay="2">
                                        <img class="cover-bg-img dsn-swiper-parallax-transform"
                                             src="assets/img/index/3.jpeg" alt=""
                                             data-dsn-position="50% 50%"/>
                                    </div>
                                    <div class="slide-content p-absolute">
                                        <div class="p-relative head-meta swiper-animate-head  d-flex justify-content-between mb-20">
                                        ...
                                        <h2 class="title has-box-mod p-relative">
                                            <a href="course" data-dsn-split="chars" class="effect-ajax"
                                               data-dsn-ajax="slider">
                ...
                <div class="control-nav w-100  d-flex dsn-container  align-items-center justify-content-between">
                    ...
                    <div class="dsn-pagination p-relative d-flex align-items-end">
                        ...
                        <span class="sm-title-block">/ </span><span
                            class="total sm-title-block"> 3</span>
                    </div>
                    ...
                    <div class="d-grid grid-md-3 grid-sm-2 dsn-service" data-dsn-iconsize="60px">
                        <div class="service-item p-relative grid-item">
                            <div class="service-item-inner align-items-center number-item h-100">
                                <div class="dsn-icon">
                                    <img decoding="async" class="cover-bg-img" src="assets/img/gif/building.gif"
                                        style="height: 60px; width: 60px;" title="" alt="" />
                                </div>
                        ...
                        <div class="service-item p-relative grid-item border-left dsn-icon-theme-color">
                            <div class="service-item-inner align-items-center number-item h-100">
                                <div class="dsn-icon">
                                    <img decoding="async" class="cover-bg-img" src="assets/img/gif/society.gif"
                                        style="height: 60px; width: 60px;" title="" alt="" />
                                </div>
                                <div class="service-content p-relative">
                                    <h4 class="service_title sm-title-block text-upper text-justify">
                        ...
                        <div class="service-item p-relative border-left grid-item">
                            <div class="service-item-inner align-items-center number-item h-100">
                                <div class="dsn-icon">
                                    <img decoding="async" class="cover-bg-img" src="assets/img/gif/join.gif"
                                        style="height: 60px; width: 60px;" title="" alt="" />
                                </div>
                                <div class="service-content p-relative">
                                    <h4 class="service_title sm-title-block text-upper text-justify">
                ...
                <div class="section-title mb-70 d-grid grid-md-2 ">
                    ...
                    <div class="dsn-def-btn dsn-icon-heading-color align-self-end justify-self-end">
                        <a class="dsn-btn dsn-border border-color-default  background-section effect-ajax effect-ajax  move-circle has-icon-left"
                           href="index" data-dsn-text="Service"
                    ...
                    <div class="dsn-service d-grid grid-lg-3 grid-sm-2 dsn-masonry-grid dsn-masonry-grid-2 dsn-isotope "
                        ...
                        <div class="dsn-up service-item p-relative grid-item style-box">
                            <div class="service-item-inner border-style number-item h-100 " >
                                <div class="dsn-icon">
                                    <img class="cover-bg-img" src="assets/img/index/co_working5-new.jpeg" alt=""/>
                                 </div>                                                                                          
                                <div class="service-content p-relative">
                                    <h4 class="service_title  title-block border-bottom pb-20 mb-20">Co-Working Space</h4>
                        ...
                        <div class="dsn-up service-item p-relative grid-item style-box">
                            <div class="service-item-inner border-style number-item h-100">
                                <div class="dsn-icon">
                                            ...
                                            <img class="cover-bg-img" src="assets/img/index/3652.JPG" alt=""/>
                                </div>
                                <div class="service-content p-relative">
                                    <h4 class="service_title  title-block border-bottom pb-20 mb-20"> Trading Courses
                                    </h4>
                                    <div class="service_description mt-20 max-w570 dsn-auto">
                                        <p>
                        ...
                        <div class="dsn-up service-item p-relative grid-item style-box">
                            <div class="service-item-inner border-style number-item h-100">
                                ...
                                <div class="service-content p-relative">
                                    <h4 class="service_title  title-block border-bottom pb-20 mb-20">Algo trading</h4>
                                    <div class="service_description mt-20 max-w570 dsn-auto">
                                        <p>
                                        Algo trading, a method driven by predefined instructions and algorithms, automates financial market trades.
                                        </p>
                                    </div>
                                    <div class="d-flex mt-20 dsn-def-btn dsn-hover-icon">
                                        <a href="algotrading"
                    ...
                    <div class="box-info background-section p-80 mt-section">
                        <div class="section-title d-flex">
                            <div class="sub-section-title">
                                ...
                                <span>START YOUR <br>JOURNEY <b>TODAY?</b></span>
                            </span>
                            </div>
                        </div>
                        <p class="mt-20">
                        Join thousands of learners on the path to financial freedom and algorithmic prowess. Whether you're a complete beginner or a seasoned trader looking to sharpen your skills, Investment Vidhya Academy is your gateway to success.
                        ...
                        <ul class="d-grid dsn-list mt-20" data-dsn-gap="10px 15px">
                            <li class="list-item d-flex align-items-center background-main">
                                ...
                                <p class="dsn-heading-title heading-color ">A Step-by-Step Course</p>
                            </li>
                            <li class="list-item d-flex align-items-center background-main">
                                <span class="dsn-icon mr-15"><i class="fas fa-check" aria-hidden="true"></i></span>
                            ...
                            <li class="list-item d-flex align-items-center background-main">
                                <span class="dsn-icon mr-15"><i class="fas fa-check" aria-hidden="true"></i></span>
                                <p class="dsn-heading-title heading-color ">Master the Art of Trading</p>
                            </li>
                        ...
                        <div class="dsn-def-btn dsn-icon-heading-color mt-20 d-flex">
                            <a class="dsn-btn dsn-border border-color-default background-main effect-ajax has-icon-left"
                               href="course" data-dsn-text="HEADPHONES">
                            <span class="dsn-icon dsn-bg-before btn-icon-left heading-color z-index-1">
                                <i class="fas fa-angle-right"></i>
                            </span>
                ...
                <div class="d-grid grid-lg-2 d-grid-no-space">
                    ...
                    <div class="box-info background-section p-80 mt-section">
                        <div class="section-title d-flex">
                            <div class="sub-section-title">
                                ...
                                <span class="title-h2 dsn-heading-title p-relative title-block-lg d-block    heading-color">
                                <span>Where  <br>Productivity and <b>Well-Being Meet</b></span>
                            </span>
                            </div>
                        </div>
                        <p class="mt-20">
                        TTA Co-Workspace merges unparalleled resources with a community of traders sharing your ambition. It's not just a space; it's your launchpad toward trading mastery. Experience trading in an environment tailor-made for triumph. Discover TTA Co-Workspace – where traders access excellence. For further details and to secure your space, explore our website or contact us . Your journey to trading excellence begins now.
                            <span class="d-block mt-10"></span>
                            Grow, Network, Thrive: The Future of Co-Working
                        </p>
                        <ul class="d-grid dsn-list mt-20" data-dsn-gap="10px 15px">
                            <li class="list-item d-flex align-items-center background-main">
                                <span class="dsn-icon mr-15"><i class="fas fa-check" aria-hidden="true"></i></span>
                                <p class="dsn-heading-title heading-color ">Your Ideal Co-Working Hub</p>
                            </li>
                            <li class="list-item d-flex align-items-center background-main">
                                <span class="dsn-icon mr-15"><i class="fas fa-check" aria-hidden="true"></i></span>
                                <p class="dsn-heading-title heading-color ">Innovative Spaces for Modern Professionals </p>
                            </li>
                            <li class="list-item d-flex align-items-center background-main">
                                <span class="dsn-icon mr-15"><i class="fas fa-check" aria-hidden="true"></i></span>
                                <p class="dsn-heading-title heading-color ">Seamless Trading Experience</p>
                            </li>

                        </ul>
                        <div class="dsn-def-btn dsn-icon-heading-color mt-20 d-flex">
                            <a class="dsn-btn dsn-border border-color-default background-main effect-ajax has-icon-left"
                               href="coworking" data-dsn-text="HEADPHONES">
                            <span class="dsn-icon dsn-bg-before btn-icon-left heading-color z-index-1">
                                <i class="fas fa-angle-right"></i>
                            </span>
                                <span class="title-btn p-relative  z-index-1 ">LEARN MORE</span>
                    ...
                    <div class="left-box-image mb-section">
                        <div class="box-img w-100"
                             data-dsn-animation='{"to":{"y":"120px"},"option":{"scrub":"0","start":"80%","end":"30%"},"responsive":["desktop"]}'>
                            <div class="img-box-parallax h-v-80 before-z-index w-100" data-overlay="1">
                                <img class="cover-bg-img" src="assets/img/index/about_3-new.webp" alt="not image"/>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- <div class="p-relative  background-section section-padding">
            ...
            <div class="p-relative background-section section-padding">
    <div class="container add_new">
        <div class="experience  ">
            <span class="exp-number dsn-animate-number">
                <span class="animate-number">19+</span>
            </span>
            <h5 class="title-block mt-30  custome">
                YEARS OF <br>Trading EXPERIENCE
            </h5>
        </div>

        <div class="experience  Users">
            <span class="exp-number dsn-animate-number">
                <span class="animate-number">2K+</span>
            </span>
            <h5 class="title-block mt-30 custome">
            Traders <br>Users
            </h5>
        ...
        <div class="experience Ratings">
            <span class="exp-number dsn-animate-number">
                <span class="animate-number">5.0</span>
            </span>
            <h5 class="title-block mt-30 custome">
            Ratings <br>
            </h5>
        ...
        <div class="about-section about-arc section-margin">
            <div class="container d-grid grid-md-2 d-grid-no-space">
                <div class="box-left box-padding">
                    ...
                    At The Trading Area (TTA), we empower traders to unlock their full potential through our advanced platform and innovative tools. Whether you're new to trading or looking to refine your strategies, TTA offers a wealth of resources designed to enhance your market understanding and trading efficiency. With real-time data, powerful analysis features, and user-friendly interfaces, you'll have everything you need to make informed decisions and seize opportunities. The Trading Area Advantage is about giving you the control and confidence to succeed in today’s fast-paced markets.
                    </p>

                    <div class="mt-20">
                        <h5 class="title-block square-after d-inline-block ">Co-Working Space</h5>
                        <span class="fw-bold d-block mt-5">Course</span>
                    </div>


                    <div class="dsn-def-btn dsn-icon-heading-color mt-30 d-flex">
                        <a class="dsn-btn dsn-border border-color-default  background-section effect-ajax effect-ajax  move-circle has-icon-left"
                           href="contact" data-dsn-text="STUDIO" data-dsn="parallax">
                        <span class="dsn-icon dsn-bg-before btn-icon-left heading-color z-index-1">
                            <i class="fas fa-angle-right"></i>
                        </span>
                ...
                <div class="box-right box-creative p-relative">
                    <div class="p-relative border-rdu over-hidden h-100">
                        <div class="img-box-parallax h-100 w-100 before-z-index dsn-animate dsn-effect-left border-rdu"
                            ...
                            <img src='assets/img/index/3.jpeg' class="cover-bg-img has-direction"
                    ...
                    <div class="img-top">
                        <img src='assets/img/index/5599.jpg' class="cover-bg-img border-rdu" alt=''/>
                    </div>
                    <div class="img-bottom">
                        <img src='assets/img/index/5545.jpg' class="cover-bg-img border-rdu" alt=''/>
                    </div>
                </div>
            </div>
                    ...
                    <div class="section-title mb-70 d-grid grid-md-2 ">
                        ...
                        <div class="dsn-def-btn dsn-icon-heading-color align-self-end justify-self-end">
                            <a class="dsn-btn dsn-border border-color-default  background-main effect-ajax move-circle has-icon-left"
                               href="contact" data-dsn-text="Contact Us" data-dsn="parallax">
                        <span class="dsn-icon dsn-bg-before btn-icon-left heading-color z-index-1">
                            <i class="fas fa-angle-right"></i>
                        </span>
