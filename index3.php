...
<body class="v-dark dsn-ajax">
    ...
    <main id="main_root" class="main-root">
        ...
        <section class="hero-section">
            <h1>Work. Learn. Thrive.</h1>
            <p>A dynamic coworking environment for professionals, entrepreneurs, and traders, paired with expert trading
                courses to elevate your skills.</p>

            <div class="cta-buttons">
                <a href="#">Book Your Workspace</a>
                <a href="#">Start Your Trading Journey</a>
            </div>

            <div class="benefits">
                <div>
                    <h3>Flexible Workspaces</h3>
                    <p>Tailored for freelancers, startups, and corporate teams.</p>
                </div>
                <div>
                    <h3>Learn to Trade</h3>
                    <p>Expert-led trading courses for every skill level.</p>
                </div>
                <div>
                    <h3>Join a Community</h3>
                    <p>Collaborate with like-minded professionals and traders.</p>
                </div>
            </div>
        </section>
                ...
                <div class="d-grid grid-md-2">
                    <div class="box-info">
                        <h2 class="title">
                            ...
                            <span>TRADING</span>
                            <span class="text-right w-100">AREA</span>
                        </h2>
                    ...
                    <div class="box-img">
                        <img decoding="async" class="cover-bg-img" src="assets/img/new/trading-hand.png" title=""
                            alt="">
                    </div>
                </div>
            </div>
