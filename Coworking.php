...
<body class="v-dark bg-dots dsn-ajax">
    ...
    <main id="main_root" class="main-root">
        ...
        <!-- ========== Play Video ========== -->
        <div class="section-video  section-margin background-section p-relative section-padding hv-100 dsn-animate-video v-dark-head"
            ...
            <div class="dsn-bg-section p-absolute w-100 h-100 over-hidden top-0 left-0">
                <div class="h-100 img-box-parallax before-z-index section-margin w-100" data-overlay="4">
                    <img src="assets/img/index/co_working5-new.jpeg" class="cover-bg-img has-direction" alt="">
                </div>
            ...
            <div class="container section-margin pt-section border-top d-grid grid-md-2" data-dsn-gap="30px 120px">
                <div class="box-left p-relative  pinned-scroll" data-dsn-option='{"end":"250"}'>
                    <div class="section-title  pinned-element">
                        <h2 class="title-h2 text-upper">Our Pricing</h2>
                        <p class="max-w350 mt-20">
                            At The Trading Area, we offer transparent and competitive pricing plans designed to suit
                ...
                <div class="box-right">
                    <div class="dsn-resume">
                        ...
                        <div class="resume-item">
                            <h4 class="sm-title-block resume-title mb-15">Monthly</h4>
                            <h6 class="resume-position">7000</h6>
                            <div class="resume-description mt-10">
                                <p>Praesent dignissim sollicitudin justo</p>
                            </div>
                        </div>
                        ...
                        <div class="resume-item">
                            <h4 class="sm-title-block resume-title mb-15">WEEKLY</h4>
                            <h6 class="resume-position">2000</h6>
                            <div class="resume-description mt-10">
                                <p>Praesent dignissim sollicitudin justo</p>
                            </div>
                        </div>
                        ...
                        <div class="resume-item">
                            <h4 class="sm-title-block resume-title mb-15">DAILY</h4>
                            <h6 class="resume-position">500</h6>
                            <div class="resume-description mt-10">
                                <p>Praesent dignissim sollicitudin justo</p>
                            </div>
                        </div>
                        ...
                        <div class="resume-item">
                            <h4 class="sm-title-block resume-title mb-15">HOURLY</h4>
                            <h6 class="resume-position">100</h6>
                            <div class="resume-description mt-10">
                                <p>Praesent dignissim sollicitudin justo</p>
                            </div>
                        </div>
                    ...
                    <div class="dsn-service d-grid grid-lg-3 grid-sm-2" data-dsn-iconsize="80px">
                        ...
                        <div class="dsn-up service-item p-relative grid-item style-box">
                            <div class="service-item-inner border-style number-item h-100">
                                <div class="dsn-icon">
                                    <img src="assets/img/gif/workplace.gif" alt="workplace.gif"
                                        style="height: 80px; width: 80px;">
                                </div>
                                <div class="service-content p-relative">
                                    <h4 class="service_title  title-block">Four screen setup</h4>
                                    <div class="service_description mt-10 max-w570 dsn-auto">
                                        <p>
                                            Fostering productivity with a four screen setup.
                                        </p>
                                    </div>
                        ...
                        <div class="dsn-up service-item p-relative grid-item style-box">
                            <div class="service-item-inner border-style number-item h-100">
                                <div class="dsn-icon">
                                    <img src="assets/img/gif/wifi.gif" alt="wifi.gif"
                                        style="height: 80px; width: 80px;">
                                </div>
                                <div class="service-content p-relative">
                                    <h4 class="service_title  title-block">high speed wi-fi</h4>
                                    <div class="service_description mt-10 max-w570 dsn-auto">
                                        <p>
                        ...
                        <div class="dsn-up service-item p-relative grid-item style-box">
                            <div class="service-item-inner border-style number-item h-100">
                                <div class="dsn-icon">
                                    <img src="assets/img/gif/maintenance.gif" alt="maintenance.gif"
                                        style="height: 80px; width: 80px;">
                                </div>
                                <div class="service-content p-relative">
                                    <h4 class="service_title  title-block">Top class Maintenance</h4>
                                    <div class="service_description mt-10 max-w570 dsn-auto">
                                        <p>
                                            Superior, top-class maintenance service.
                                        </p>
                                    </div>
                        ...
                        <div class="dsn-up service-item p-relative grid-item style-box">
                            <div class="service-item-inner border-style number-item h-100">
                                <div class="dsn-icon">
                                    <img src="assets/img/gif/backup.gif" alt="backup.gif"
                                        style="height: 80px; width: 80px;">
                                </div>
                                <div class="service-content p-relative">
                                    <h4 class="service_title  title-block">power backup</h4>
                                    <div class="service_description mt-10 max-w570 dsn-auto">
                                        <p>
                        ...
                        <div class="dsn-up service-item p-relative grid-item style-box">
                            <div class="service-item-inner border-style number-item h-100">
                                <div class="dsn-icon">
                                    <img src="assets/img/gif/air-conditioner.gif" alt="air-conditioner.gif"
                                        style="height: 80px; width: 80px;">
                                </div>
                                <div class="service-content p-relative">
                                    <h4 class="service_title  title-block">air conditioner</h4>
                                    <div class="service_description mt-10 max-w570 dsn-auto">
                                        <p>
                        ...
                        <div class="dsn-up service-item p-relative grid-item style-box">
                            <div class="service-item-inner border-style number-item h-100">
                                <div class="dsn-icon">
                                    <img src="assets/img/gif/office-chair.gif" alt="office-chair.gif"
                                        style="height: 80px; width: 80px;">
                                </div>
                                <div class="service-content p-relative">
                                    <h4 class="service_title  title-block">hassle free setup</h4>
                                    <div class="service_description mt-10 max-w570 dsn-auto">
                                        <p>
                                            Seamless, hassle-free setup experience.
                                        </p>
                                    </div>
                        ...
                        <div class="dsn-up service-item p-relative grid-item style-box">
                            <div class="service-item-inner border-style number-item h-100">
                                <div class="dsn-icon">
                                    <img src="assets/img/gif/up_down.gif" alt="office-chair.gif"
                                        style="height: 80px; width: 80px;">
                                </div>
                                <div class="service-content p-relative">
                                    <h4 class="service_title  title-block">Trade-centric co-working.</h4>
                                    <div class="service_description mt-10 max-w570 dsn-auto">
                                        <p>
                                            Collaborative co-working space for trading.
                                        </p>
                                    </div>
                        ...
                        <div class="dsn-up service-item p-relative grid-item style-box">
                            <div class="service-item-inner border-style number-item h-100">
                                <div class="dsn-icon">
                                    <img src="assets/img/gif/parking.gif" alt="office-chair.gif"
                                        style="height: 80px; width: 80px;">
                                </div>
                                <div class="service-content p-relative">
                                    <h4 class="service_title  title-block">parking</h4>
                                    <div class="service_description mt-10 max-w570 dsn-auto">
                                        <p>
                                            Easy access parking facility.
                                        </p>
                                    </div>
                        ...
                        <div class="dsn-up service-item p-relative grid-item style-box">
                            <div class="service-item-inner border-style number-item h-100">
                                <div class="dsn-icon">
                                    <img src="assets/img/gif/inheritance.gif" alt="office-chair.gif"
                                        style="height: 80px; width: 80px;">
                                </div>
                                <div class="service-content p-relative">
                                    <h4 class="service_title  title-block">networking</h4>
                                    <div class="service_description mt-10 max-w570 dsn-auto">
                                        <p>
                                            Enhancing connectivity with smart networking.
                                        </p>
                                    </div>
        ...
        "autoplay": {
            ...
            <div class="container" style="margin-top:-50px;">
                <div class="col">
                    <div class="col gx-5" style="margin-top:100px;">
                            ...
                            <div class="map " id='g_map'>
                                <div class="mapouter">
                                    <div class="gmap_canvas">
                                        <iframe
                                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3692.167920424321!2d70.76587507418624!3d22.27162807970723!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3959cb0659d33e9d%3A0x231b27fa7abbd59c!2sThe%20Trading%20Area!5e0!3m2!1sen!2sin!4v1700579532036!5m2!1sen!2sin"
                                            scrolling="no" style="height:40vh; width:100%;border-radius:10px"></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
