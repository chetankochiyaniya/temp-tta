        ...
        <div class="container section-margin pt-section border-top d-grid grid-md-2" data-dsn-gap="30px 120px">
                <div class="box-left p-relative  pinned-scroll" data-dsn-option='{"end":"250"}'>
                    <div class="section-title  pinned-element">
                        ...
                        At The Trading Area, we offer transparent and competitive pricing plans designed to suit traders of all levels. 
                        </p>
                    </div>
                </div>
                <div class="box-right">
                    ...
                    <div class="dsn-service d-grid grid-lg-3 grid-sm-2" data-dsn-iconsize="80px">
                        ...
                        <div class="dsn-up service-item p-relative grid-item style-box">
                            <div class="service-item-inner border-style number-item h-100">
                                <div class="dsn-icon">
                                    <img src="assets/img/gif/workplace.gif" alt="workplace.gif" style="height: 80px; width: 80px;">
                                </div>
                        ...
                        <div class="dsn-up service-item p-relative grid-item style-box">
                            <div class="service-item-inner border-style number-item h-100">
                                <div class="dsn-icon">
                                    <img src="assets/img/gif/wifi.gif" alt="wifi.gif" style="height: 80px; width: 80px;">
                                </div>
                                <div class="service-content p-relative">
                        ...
                        <div class="dsn-up service-item p-relative grid-item style-box">
                            <div class="service-item-inner border-style number-item h-100">
                                <div class="dsn-icon">
                                    <img src="assets/img/gif/maintenance.gif" alt="maintenance.gif" style="height: 80px; width: 80px;">
                                </div>
                                <div class="service-content p-relative">
                        ...
                        <div class="dsn-up service-item p-relative grid-item style-box">
                            <div class="service-item-inner border-style number-item h-100">
                                <div class="dsn-icon">
                                    <img src="assets/img/gif/backup.gif" alt="backup.gif" style="height: 80px; width: 80px;">
                                </div>
                                <div class="service-content p-relative">
                        ...
                        <div class="dsn-up service-item p-relative grid-item style-box">
                            <div class="service-item-inner border-style number-item h-100">
                                <div class="dsn-icon">
                                    <img src="assets/img/gif/air-conditioner.gif" alt="air-conditioner.gif" style="height: 80px; width: 80px;">
                                </div>
                                <div class="service-content p-relative">
                        ...
                        <div class="dsn-up service-item p-relative grid-item style-box">
                            <div class="service-item-inner border-style number-item h-100">
                                <div class="dsn-icon">
                                    <img src="assets/img/gif/office-chair.gif" alt="office-chair.gif" style="height: 80px; width: 80px;">
                                </div>
                                <div class="service-content p-relative">
                        ...
                        <div class="dsn-up service-item p-relative grid-item style-box">
                            <div class="service-item-inner border-style number-item h-100">
                                <div class="dsn-icon">
                                    <img src="assets/img/gif/up_down.gif" alt="office-chair.gif" style="height: 80px; width: 80px;">
                                </div>
                                <div class="service-content p-relative">
                        ...
                        <div class="dsn-up service-item p-relative grid-item style-box">
                            <div class="service-item-inner border-style number-item h-100">
                                <div class="dsn-icon">
                                    <img src="assets/img/gif/parking.gif" alt="office-chair.gif" style="height: 80px; width: 80px;">
                                </div>
                                <div class="service-content p-relative">
                        ...
                        <div class="dsn-up service-item p-relative grid-item style-box">
                            <div class="service-item-inner border-style number-item h-100">
                                <div class="dsn-icon">
                                    <img src="assets/img/gif/inheritance.gif" alt="office-chair.gif" style="height: 80px; width: 80px;">
                                </div>
                                <div class="service-content p-relative">
