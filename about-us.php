                ...
                <div class="content p-relative ">
                    <div class="intro-project w-100">
                        <div class="intro-title ">
                            ...
                            <div id="hero_title" class="mt-20">
                                <h3 class=" text-upper">Welcome to The Trading Area Our Co-Working Space <br> and Trading Course</h3>
                            </div>
                            <p class="mt-20 max-w570">
                            Explore how our co-working space and trading course can help you achieve your professional goals. Join our community today and take the next step in your trading journey with The Trading Area.
                            </p>
                            <div class="dsn-def-btn dsn-hover-icon dsn-icon-heading-color mt-20 d-flex">
                                <a class="dsn-btn dsn-border border-color-default  background-section effect-ajax has-icon-left"
                                   href="contact" data-dsn-text="Contact Us">
    ...
    <div id="page_wrapper" class="wrapper">
        ...
        <div class="box-under-bottom-img mb-section">
            <div class="img-box-parallax before-z-index dsn-animate dsn-effect-down h-v-80"
                ...
                <img class="has-bigger-scale cover-bg-img has-direction" src='assets/img/index/about_2.jpeg' alt=''/>
            </div>
            <div class="p-relative content container background-theme box-padding border-rdu text-center">
                <h5 class=""><b>Discover How The Trading Area Combines Cutting-Edge Co-Working Spaces with Expert-Led Trading Courses to Elevate Your Trading Experience</b></h5>
                <p class="dsn-heading-title mt-20 max-w750">
                At The Trading Area, we believe in creating a supportive community for traders. Our facilities and courses are designed to help you achieve your trading goals and excel in the financial markets. We strive to offer a top-notch experience that combines state-of-the-art technology with expert instruction.
                </p>
            </div>
        </div>
        <!-- ========== End About Section ========== -->
